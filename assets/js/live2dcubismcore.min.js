...
(function(Live2DCubismCore) {
    var _em_module = function() {
        ...
        return function(_em_module) {
            ...
            if (ENVIRONMENT_IS_NODE) {
                ...
                if (typeof read != "undefined") { Module["read"] = function shell_read(f) { var data = tryParseAsDataURI(f); if (data) { return intArrayToString(data) } return read(f) } }
            ...
            var asm = function(global, env, buffer) {
                ...
                function za(a, c, d) {
                    ...
                    if ((d | 0) > 0) {
                        ...
                        do {
                            ...
                            switch (P | 0) {
                                case 0:
                                    { f[g + (d << 5) + 16 >> 2] = 1;f[g + (d << 5) + 20 >> 2] = 1;f[g + (d << 5) + 24 >> 2] = (f[z >> 2] | 0) + (i * 24 | 0); break }
                                case 1:
                                    { f[g + (d << 5) + 16 >> 2] = 2;f[g + (d << 5) + 20 >> 2] = 2;f[g + (d << 5) + 24 >> 2] = (f[B >> 2] | 0) + (i << 5); break }
                                default:
                                    wa(4, 2896, y)
                            }
                        } while ((e | 0) > 1);
                ...
                function fb(a, b) {
                    ...
                    if (c < -3.1415927410125732)
                        do { c = c + 6.2831854820251465 } while (c < -3.1415927410125732);
                            ...
                            while (1) {
                                do {
                                    if (!(f[g + 4 >> 2] | 0)) j = 0;
                                        ...
                                        $ = f[g >> 2] | 0;
                                        if (($ | 0) != -1 ? (f[m + ($ << 2) >> 2] | 0) == 0 : 0) { j = 0; break }
                        ...
                        while (1) {
                            do {
                                if (!(f[c + 28 >> 2] | 0)) d = 0;
                                    ...
                                    S = f[c >> 2] | 0;
                                    if ((S | 0) != -1 ? (f[k + (S << 2) >> 2] | 0) == 0 : 0) { d = 0; break }
                                    S = f[c + 4 >> 2] | 0;
                                    if ((S | 0) != -1 ? (f[l + (S << 2) >> 2] | 0) == 0 : 0) { d = 0; break }
                            ...
                            switch (f[c + 8 >> 2] | 0) {
                                case 0:
                                    { f[m + (f[c + 12 >> 2] << 2) >> 2] = d; break }
                                case 1:
                                    { f[o + (f[c + 12 >> 2] << 2) >> 2] = d; break }
                                default:
                                    wa(4, 4254, K)
                            }
                            c = c + 32 | 0;
                        ...
                        while (1) {
                            do {
                                if (!(f[c + 8 >> 2] | 0)) g = 0;
                                    ...
                                    ua = f[c >> 2] | 0;
                                    if ((ua | 0) != -1 ? (f[i + (ua << 2) >> 2] | 0) == 0 : 0) { g = 0; break }
                                    ua = f[c + 4 >> 2] | 0;
                                    if ((ua | 0) != -1 ? (f[j + (ua << 2) >> 2] | 0) == 0 : 0) { g = 0; break }
                ...
                function Bb(a) { a = a | 0; return Db(a) | 0 }
                                    ...
                                    if (h >>> 0 > i >>> 0) {
                                        ...
                                        do {
                                            if (e | 0) {
                                                b = f[i + 28 >> 2] | 0;
                                                a = 5728 + (b << 2) | 0;
                                                if ((i | 0) == (f[a >> 2] | 0)) { f[a >> 2] = c; if (!c) { f[1357] = g & ~(1 << b); break } } else {
                                                    w = e + 16 | 0;
                                            ...
                                            c: do {
                                                if ((f[b + 4 >> 2] & -8 | 0) != (h | 0)) {
                                                    ...
                                                    while (1) {
                                                        ...
                                                        a = f[c >> 2] | 0;
                                                        if (!a) break;
                                                        if ((f[a + 4 >> 2] & -8 | 0) == (h | 0)) { b = a; break c } else {
                                                            d = d << 1;
                                                            b = a
                                                        }
                                                    }
                            ...
                            do {
                                if ((q | 0) == 128) {
                                    ...
                                    if ((c | 0) != (-1 | 0) ? (b = c, o = f[1475] | 0, p = o + -1 | 0, b = ((p & b | 0) == 0 ? 0 : (p + b & 0 - o) - b | 0) + k | 0, o = f[1464] | 0, p = b + o | 0, b >>> 0 > m >>> 0 & b >>> 0 < 2147483647) : 0) {
                                        n = f[1466] | 0;
                                        if (n | 0 ? p >>> 0 <= o >>> 0 | p >>> 0 > n >>> 0 : 0) { b = 0; break }
                                        a = Ic(b | 0) | 0;
                                        if ((a | 0) == (c | 0)) {
                                            h = b;
                                            g = c;
                                            ...
                                            if ((a & 3 | 0) == 1) {
                                                ...
                                                h: do {
                                                    if (a >>> 0 < 256) {
                                                        a = f[b + 8 >> 2] | 0;
                                                        c = f[b + 12 >> 2] | 0;
                                                        if ((c | 0) == (a | 0)) { f[1356] = f[1356] & ~(1 << d); break } else {
                                                            f[a + 12 >> 2] = c;
                                                            f[c + 8 >> 2] = a;
                                                            break
                                                        }
                                                        ...
                                                        do {
                                                            if ((a | 0) == (b | 0)) {
                                                                ...
                                                                d = c + 4 | 0;
                                                                a = f[d >> 2] | 0;
                                                                if (!a) { a = f[c >> 2] | 0; if (!a) { a = 0; break } } else c = d;
                                                                while (1) {
                                                                    e = a + 20 | 0;
                                                                    d = f[e >> 2] | 0;
                                                                    if (!d) {
                                            ...
                                            i: do {
                                                if ((f[b + 4 >> 2] & -8 | 0) != (e | 0)) {
                                                    ...
                                                    while (1) {
                                                        ...
                                                        a = f[c >> 2] | 0;
                                                        if (!a) break;
                                                        if ((f[a + 4 >> 2] & -8 | 0) == (e | 0)) { b = a; break i } else {
                                                            d = d << 1;
                                                            b = a
                                                        }
                                                    }
                                    ...
                                    j: do {
                                        if ((f[b + 4 >> 2] & -8 | 0) != (g | 0)) {
                                            ...
                                            while (1) {
                                                ...
                                                a = f[c >> 2] | 0;
                                                if (!a) break;
                                                if ((f[a + 4 >> 2] & -8 | 0) == (g | 0)) { b = a; break j } else {
                                                    d = d << 1;
                                                    b = a
                                                }
                                            }
                        ...
                        if (!(a & 1)) {
                            ...
                            do {
                                if ((a | 0) == (h | 0)) {
                                    ...
                                    c = b + 4 | 0;
                                    a = f[c >> 2] | 0;
                                    if (!a) { a = f[b >> 2] | 0; if (!a) { a = 0; break } } else b = c;
                                    while (1) {
                                        d = a + 20 | 0;
                                        c = f[d >> 2] | 0;
                                        if (!c) {
                    ...
                    if (!(d & 2)) {
                        ...
                        do {
                            if (d >>> 0 < 256) {
                                b = f[j + 8 >> 2] | 0;
                                a = f[j + 12 >> 2] | 0;
                                if ((a | 0) == (b | 0)) { f[1356] = f[1356] & ~(1 << c); break } else {
                                    f[b + 12 >> 2] = a;
                                    f[a + 8 >> 2] = b;
                                    break
                                }
                                ...
                                do {
                                    if ((a | 0) == (j | 0)) {
                                        ...
                                        c = b + 4 | 0;
                                        a = f[c >> 2] | 0;
                                        if (!a) { a = f[b >> 2] | 0; if (!a) { c = 0; break } } else b = c;
                                        while (1) {
                                            d = a + 20 | 0;
                                            c = f[d >> 2] | 0;
                                            if (!c) {
                                ...
                                if (g | 0) {
                                    a = f[j + 28 >> 2] | 0;
                                    b = 5728 + (a << 2) | 0;
                                    if ((f[b >> 2] | 0) == (j | 0)) { f[b >> 2] = c; if (!c) { f[1357] = f[1357] & ~(1 << a); break } } else {
                                        d = g + 16 | 0;
                        ...
                        f[i + 4 >> 2] = e | 1;
                        f[h + e >> 2] = e;
                        if ((i | 0) == (f[1361] | 0)) { f[1358] = e; return }
                    } else {
                        f[a >> 2] = d & -2;
                        f[i + 4 >> 2] = b | 1;
                        f[h + b >> 2] = b;
                            ...
                            b: do {
                                if ((f[a + 4 >> 2] & -8 | 0) != (e | 0)) {
                                    ...
                                    while (1) {
                                        ...
                                        b = f[c >> 2] | 0;
                                        if (!b) break;
                                        if ((f[b + 4 >> 2] & -8 | 0) == (e | 0)) { a = b; break b } else {
                                            d = d << 1;
                                            a = b
                                        }
                                    }
                    ...
                    do {
                        if (!(c & 1)) {
                            ...
                            if (g) {
                                c = f[h + 28 >> 2] | 0;
                                d = 5728 + (c << 2) | 0;
                                if ((f[d >> 2] | 0) == (h | 0)) { f[d >> 2] = a; if (!a) { f[1357] = f[1357] & ~(1 << c); break } } else {
                                    e = g + 16 | 0;
                    ...
                    if (!(d & 2)) {
                        ...
                        do {
                            if (d >>> 0 < 256) {
                                a = f[i + 8 >> 2] | 0;
                                b = f[i + 12 >> 2] | 0;
                                if ((b | 0) == (a | 0)) { f[1356] = f[1356] & ~(1 << c); break } else {
                                    f[a + 12 >> 2] = b;
                                    f[b + 8 >> 2] = a;
                                    break
                                }
                                ...
                                do {
                                    if ((b | 0) == (i | 0)) {
                                        ...
                                        c = a + 4 | 0;
                                        b = f[c >> 2] | 0;
                                        if (!b) { b = f[a >> 2] | 0; if (!b) { c = 0; break } } else a = c;
                                        while (1) {
                                            d = b + 20 | 0;
                                            c = f[d >> 2] | 0;
                                            if (!c) {
                                ...
                                if (g | 0) {
                                    b = f[i + 28 >> 2] | 0;
                                    a = 5728 + (b << 2) | 0;
                                    if ((f[a >> 2] | 0) == (i | 0)) { f[a >> 2] = c; if (!c) { f[1357] = f[1357] & ~(1 << b); break } } else {
                                        d = g + 16 | 0;
                        ...
                        f[h + 4 >> 2] = e | 1;
                        f[h + e >> 2] = e;
                        if ((h | 0) == (f[1361] | 0)) { f[1358] = e; return }
                    } else {
                        f[a >> 2] = d & -2;
                        f[h + 4 >> 2] = b | 1;
                        f[h + b >> 2] = b;
                    ...
                    a: do {
                        if ((f[b + 4 >> 2] & -8 | 0) != (e | 0)) {
                            ...
                            while (1) {
                                ...
                                a = f[c >> 2] | 0;
                                if (!a) break;
                                if ((f[a + 4 >> 2] & -8 | 0) == (e | 0)) { b = a; break a } else {
                                    d = d << 1;
                                    b = a
                                }
                            }
                ...
                function Hb(a, b, c) {
                    ...
                    c = c | 0;
                    var d = 0;
                    do { if ((b | 0) != 8) { d = 2 ? b >>> 2 : b; if ((b & 3 | 0) != 0 | (d | 0) == 0) { a = 22; return a | 0 } if (d + 1073741823 & d | 0) { a = 22; return a | 0 } if ((-64 - b | 0) >>> 0 < c >>> 0) { a = 12; return a | 0 } else { b = Gb(b >>> 0 > 16 ? b : 16, c) | 0; break } } else b = Db(c) | 0 } while (0);
                    if (!b) { a = 12; return a | 0 }
                    f[a >> 2] = b;
                    a = 0;
                    return a | 0
                }
                ...
                function Mb() { return 5984 }

                function Nb(a) { a = a | 0; return a | 0 }
                ...
                function Rb(a) { a = a | 0; return (a + -48 | 0) >>> 0 < 10 | 0 }
                ...
                function Ub(a, c, e, g, h) {
                    ...
                    a: while (1) {
                        ...
                        q = 0;
                        while (1) {
                            if (((b[j >> 0] | 0) + -65 | 0) >>> 0 > 57) { c = -1; break a }
                            k = j;
                            j = j + 1 | 0;
                            f[C >> 2] = j;
                        ...
                        if (!(k << 24 >> 24)) { c = -1; break }
                        n = (o | 0) > -1;
                        do {
                            if (k << 24 >> 24 == 19)
                                if (n) { c = -1; break a } else v = 54;
                            else {
                                if (n) {
                                    f[h + (o << 2) >> 2] = m;
                                    n = g + (o << 3) | 0;
                                ...
                                e: do {
                                    switch (j | 0) {
                                        case 110:
                                            switch ((q & 255) << 24 >> 24) {
                                                case 0:
                                                    { f[f[D >> 2] >> 2] = c;i = 0; break d }
                                                case 1:
                                                    { f[f[D >> 2] >> 2] = c;i = 0; break d }
                                                case 2:
                                                    { i = f[D >> 2] | 0;f[i >> 2] = c;f[i + 4 >> 2] = ((c | 0) < 0) << 31 >> 31;i = 0; break d }
                                                case 3:
                                                    { d[f[D >> 2] >> 1] = c;i = 0; break d }
                                                case 4:
                                                    { b[f[D >> 2] >> 0] = c;i = 0; break d }
                                                case 6:
                                                    { f[f[D >> 2] >> 2] = c;i = 0; break d }
                                                case 7:
                                                    { i = f[D >> 2] | 0;f[i >> 2] = c;f[i + 4 >> 2] = ((c | 0) < 0) << 31 >> 31;i = 0; break d }
                                        ...
                                        case 112:
                                            { j = 120;i = i >>> 0 > 8 ? i : 8;k = o | 8;v = 67; break }
                                        case 88:
                                        case 120:
                                            { k = o;v = 67; break }
                                        case 111:
                                            { k = D;j = f[k >> 2] | 0;k = f[k + 4 >> 2] | 0;n = $b(j, k, x) | 0;v = y - n | 0;l = 0;m = 4318;i = (o & 8 | 0) == 0 | (i | 0) > (v | 0) ? i : v + 1 | 0;v = 73; break }
                                        case 105:
                                        case 100:
                                            {
                                                k = D;j = f[k >> 2] | 0;k = f[k + 4 >> 2] | 0;
                                                if ((k | 0) < 0) {
                                                    j = zc(0, 0, j | 0, k | 0) | 0;
                                                    k = ba() | 0;
                                                    l = D;
                                        ...
                                        case 117:
                                            { k = D;l = 0;m = 4318;j = f[k >> 2] | 0;k = f[k + 4 >> 2] | 0;v = 72; break }
                                        case 99:
                                            { b[z >> 0] = f[D >> 2];q = z;l = 0;m = 4318;n = 1;i = y; break }
                                        case 109:
                                            { j = Mb() | 0;j = bc(f[j >> 2] | 0) | 0;v = 77; break }
                                        case 115:
                                            { j = f[D >> 2] | 0;j = (j | 0) == 0 ? 4328 : j;v = 77; break }
                                        case 67:
                                            { f[F >> 2] = f[D >> 2];f[A >> 2] = 0;f[D >> 2] = F;m = -1;v = 81; break }
                                        case 83:
                                            {
                                                if (!i) {
                                                    dc(a, 32, s, 0, o);
                                        ...
                                        case 102:
                                        case 101:
                                            { i = fc(a, +p[D >> 3], s, i, o, j) | 0; break d }
                                        default:
                                            { q = r;l = 0;m = 4318;n = i;k = o;i = y }
                                    }
                                } while (0);
                                f: do {
                                    if ((v | 0) == 67) {
                                        ...
                                        while (1) {
                                            ...
                                            j = ec(G, j) | 0;
                                            k = (j | 0) < 0;
                                            if (k | j >>> 0 > (m - i | 0) >>> 0) { v = 85; break }
                                            i = j + i | 0;
                                            if (m >>> 0 > i >>> 0) l = l + 4 | 0;
                                            else break
                                        }
                                        if ((v | 0) == 85) { v = 0; if (k) { c = -1; break a } }
                                        dc(a, 32, s, i, o);
                                        if (!i) {
                                            i = 0;
                                            v = 91
                                            ...
                                            while (1) {
                                                ...
                                                j = ec(G, j) | 0;
                                                l = j + l | 0;
                                                if ((l | 0) > (i | 0)) { v = 91; break f }
                                                Xb(a, G, j);
                                                if (l >>> 0 >= i >>> 0) { v = 91; break } else k = k + 4 | 0
                                            }
                                        }
                                    }
                                } while (0);
                            ...
                            if (!a)
                                if (!k) c = 0;
                                    ...
                                    while (1) {
                                        ...
                                        Zb(g + (c << 3) | 0, i, e);
                                        c = c + 1 | 0;
                                        if (c >>> 0 >= 10) { c = 1; break g }
                                    }
                                    while (1) {
                                        if (f[h + (c << 2) >> 2] | 0) { c = -1; break g }
                                        c = c + 1 | 0;
                                        if (c >>> 0 >= 10) { c = 1; break }
                                    }
                                }
                    ...
                    a: do {
                        if (b >>> 0 <= 20)
                            do {
                                switch (b | 0) {
                                    case 9:
                                        { d = (f[c >> 2] | 0) + (4 - 1) & ~(4 - 1);b = f[d >> 2] | 0;f[c >> 2] = d + 4;f[a >> 2] = b; break a }
                                    case 10:
                                        { d = (f[c >> 2] | 0) + (4 - 1) & ~(4 - 1);b = f[d >> 2] | 0;f[c >> 2] = d + 4;d = a;f[d >> 2] = b;f[d + 4 >> 2] = ((b | 0) < 0) << 31 >> 31; break a }
                                    case 11:
                                        { d = (f[c >> 2] | 0) + (4 - 1) & ~(4 - 1);b = f[d >> 2] | 0;f[c >> 2] = d + 4;d = a;f[d >> 2] = b;f[d + 4 >> 2] = 0; break a }
                                    case 12:
                                        { d = (f[c >> 2] | 0) + (8 - 1) & ~(8 - 1);b = d;e = f[b >> 2] | 0;b = f[b + 4 >> 2] | 0;f[c >> 2] = d + 8;d = a;f[d >> 2] = e;f[d + 4 >> 2] = b; break a }
                                    case 13:
                                        { e = (f[c >> 2] | 0) + (4 - 1) & ~(4 - 1);d = f[e >> 2] | 0;f[c >> 2] = e + 4;d = (d & 65535) << 16 >> 16;e = a;f[e >> 2] = d;f[e + 4 >> 2] = ((d | 0) < 0) << 31 >> 31; break a }
                                    case 14:
                                        { e = (f[c >> 2] | 0) + (4 - 1) & ~(4 - 1);d = f[e >> 2] | 0;f[c >> 2] = e + 4;e = a;f[e >> 2] = d & 65535;f[e + 4 >> 2] = 0; break a }
                                    case 15:
                                        { e = (f[c >> 2] | 0) + (4 - 1) & ~(4 - 1);d = f[e >> 2] | 0;f[c >> 2] = e + 4;d = (d & 255) << 24 >> 24;e = a;f[e >> 2] = d;f[e + 4 >> 2] = ((d | 0) < 0) << 31 >> 31; break a }
                                    case 16:
                                        { e = (f[c >> 2] | 0) + (4 - 1) & ~(4 - 1);d = f[e >> 2] | 0;f[c >> 2] = e + 4;e = a;f[e >> 2] = d & 255;f[e + 4 >> 2] = 0; break a }
                                    case 17:
                                        { e = (f[c >> 2] | 0) + (8 - 1) & ~(8 - 1);g = +p[e >> 3];f[c >> 2] = e + 8;p[a >> 3] = g; break a }
                                    case 18:
                                        { e = (f[c >> 2] | 0) + (8 - 1) & ~(8 - 1);g = +p[e >> 3];f[c >> 2] = e + 8;p[a >> 3] = g; break a }
                                    default:
                                        break a
                ...
                function cc(a, c, d) {
                    ...
                    a: do {
                        if (e & (a & 3 | 0) != 0) {
                            g = c & 255;
                            while (1) {
                                if ((b[a >> 0] | 0) == g << 24 >> 24) { i = 6; break a }
                                a = a + 1 | 0;
                                d = d + -1 | 0;
                                e = (d | 0) != 0;
                                if (!(e & (a & 3 | 0) != 0)) { i = 5; break }
                            }
                        } else i = 5
                    } while (0);
                    if ((i | 0) == 5)
                            ...
                            if ((u | 0) == 97) {
                                ...
                                do {
                                    if (!(e >>> 0 > 11 | (j | 0) == 0)) {
                                        ...
                                        if ((b[r >> 0] | 0) == 45) { c = -(c + (-q - c)); break } else { c = q + c - c; break }
                                    } else c = q
                                } while (0);
                                k = f[v >> 2] | 0;
                                j = (k | 0) < 0 ? 0 - k | 0 : k;
                            ...
                            if (r) {
                                ...
                                if (m >>> 0 < v >>> 0 & (k | 0) > 0)
                                    while (1) {
                                        ...
                                        m = m + 4 | 0;
                                        l = k + -9 | 0;
                                        if (!(m >>> 0 < v >>> 0 & (k | 0) > 9)) { k = l; break } else k = l
                                    }
                                dc(a, 48, k + 9 | 0, 9, 0)
                            } else {
                                v = u ? v : n + 4 | 0;
                ...
                function ic(a, b) {
                    ...
                    switch (e & 2047) {
                        ...
                        case 2047:
                            break;
                        default:
                            { f[b >> 2] = (e & 2047) + -1022;f[s >> 2] = c;f[s + 4 >> 2] = d & -2146435073 | 1071644672;a = +p[s >> 3] }
                    }
                    return +a
                }
                ...
                function kc() { return lc() | 0 }

                function lc() { return 2652 }

                function mc() { return lc() | 0 }
                    ...
                    a: do {
                        if ((h >>> 0 < (2 ? c >>> 2 : c) >>> 0 ? (n = c - (h << 2) | 0, e >>> 0 < n >>> 0 & g >>> 0 < n >>> 0) : 0) ? ((g | e) & 3 | 0) == 0 : 0) {
                            ...
                            while (1) {
                                ...
                                if (!(g >>> 0 < c >>> 0 & e >>> 0 < (c - g | 0) >>> 0)) { e = 0; break a }
                                if (b[a + (g + e) >> 0] | 0) { e = 0; break a }
                                e = Pb(d, a + g | 0) | 0;
                                if (!e) break;
                                e = (e | 0) < 0;
                                if ((h | 0) == 1) { e = 0; break a }
                                l = e ? l : k;
                                h = e ? j : h - j | 0
                            }
                            e = i + m | 0;
                ...
                function sc(a, c, d) {
                    ...
                    a: do {
                        if ((h | 0) == 5) {
                            ...
                            i = f[j >> 2] | 0;
                            e = i;
                            if ((g - i | 0) >>> 0 < c >>> 0) { e = na[f[d + 36 >> 2] & 7](d, a, c) | 0; break }
                            b: do {
                ...
                function Dc(a, b, c) {
                    ...
                    b = b | 0;
                    c = c | 0;
                    if ((c | 0) < 32) { aa(b >>> c | 0); return a >>> c | (b & (1 << c) - 1) << 32 - c }
                    aa(0);
                    return b >>> c - 32 | 0
                }
                ...
                function Ec(a, b, c) {
                    ...
                    b = b | 0;
                    c = c | 0;
                    if ((c | 0) < 32) { aa(b << c | (a & (1 << c) - 1 << 32 - c) >>> 32 - c | 0); return a << c }
                    aa(a << c - 32 | 0);
                    return 0
                }

                function Fc(a) { a = a | 0; return (a & 255) << 24 | (a >> 8 & 255) << 16 | (a >> 16 & 255) << 8 | a >>> 24 | 0 }
            ...
            if (memoryInitializer) {
                ...
                if (ENVIRONMENT_IS_NODE || ENVIRONMENT_IS_SHELL) {
                    ...
                    if (memoryInitializerBytes) { applyMemoryInitializer(memoryInitializerBytes.buffer) } else if (Module["memoryInitializerRequest"]) {
                        function useRequest() {
                            var request = Module["memoryInitializerRequest"];
                            var response = request.response;
                            if (request.status !== 200 && request.status !== 0) {
                                var data = tryParseAsDataURI(Module["memoryInitializerRequestURL"]);
                                if (data) { response = data.buffer } else {
                        ...
                        if (Module["memoryInitializerRequest"].response) { setTimeout(useRequest, 0) } else { Module["memoryInitializerRequest"].addEventListener("load", useRequest) }
                    } else { doBrowserLoad() }
                }
            }
    ...
    else if (typeof define === "function" && define["amd"]) define([], function() { return _em_module });
    else if (typeof exports === "object") exports["_em_module"] = _em_module;
    var _em = _em_module();
    var _csm = function() {
        function _csm() {}
        _csm.getSizeofModel = function(moc) { return _em.ccall("csmGetSizeofModel", "number", ["number"], [moc]) };
        _csm.reviveMocInPlace = function(memory, mocSize) { return _em.ccall("csmReviveMocInPlace", "number", ["number", "number"], [memory, mocSize]) };
        _csm.initializeModelInPlace = function(moc, memory, modelSize) { return _em.ccall("csmInitializeModelInPlace", "number", ["number", "number", "number"], [moc, memory, modelSize]) };
        _csm.getParameterCount = function(model) { return _em.ccall("csmGetParameterCount", "number", ["number"], [model]) };
        _csm.getParameterIds = function(model) { return _em.ccall("csmGetParameterIds", "number", ["number"], [model]) };
        _csm.getParameterMinimumValues = function(model) { return _em.ccall("csmGetParameterMinimumValues", "number", ["number"], [model]) };
        _csm.getParameterMaximumValues = function(model) { return _em.ccall("csmGetParameterMaximumValues", "number", ["number"], [model]) };
        _csm.getParameterDefaultValues = function(model) { return _em.ccall("csmGetParameterDefaultValues", "number", ["number"], [model]) };
        _csm.getParameterValues = function(model) { return _em.ccall("csmGetParameterValues", "number", ["number"], [model]) };
        _csm.getPartCount = function(model) { return _em.ccall("csmGetPartCount", "number", ["number"], [model]) };
        _csm.getPartIds = function(model) { return _em.ccall("csmGetPartIds", "number", ["number"], [model]) };
        _csm.getPartOpacities = function(model) { return _em.ccall("csmGetPartOpacities", "number", ["number"], [model]) };
        _csm.getPartParentPartIndices = function(model) { return _em.ccall("csmGetPartParentPartIndices", "number", ["number"], [model]) };
        _csm.getDrawableCount = function(model) { return _em.ccall("csmGetDrawableCount", "number", ["number"], [model]) };
        _csm.getDrawableIds = function(model) { return _em.ccall("csmGetDrawableIds", "number", ["number"], [model]) };
        _csm.getDrawableConstantFlags = function(model) { return _em.ccall("csmGetDrawableConstantFlags", "number", ["number"], [model]) };
        _csm.getDrawableDynamicFlags = function(model) { return _em.ccall("csmGetDrawableDynamicFlags", "number", ["number"], [model]) };
        _csm.getDrawableTextureIndices = function(model) { return _em.ccall("csmGetDrawableTextureIndices", "number", ["number"], [model]) };
        _csm.getDrawableDrawOrders = function(model) { return _em.ccall("csmGetDrawableDrawOrders", "number", ["number"], [model]) };
        _csm.getDrawableRenderOrders = function(model) { return _em.ccall("csmGetDrawableRenderOrders", "number", ["number"], [model]) };
        _csm.getDrawableOpacities = function(model) { return _em.ccall("csmGetDrawableOpacities", "number", ["number"], [model]) };
        _csm.getDrawableMaskCounts = function(model) { return _em.ccall("csmGetDrawableMaskCounts", "number", ["number"], [model]) };
        _csm.getDrawableMasks = function(model) { return _em.ccall("csmGetDrawableMasks", "number", ["number"], [model]) };
        _csm.getDrawableVertexCounts = function(model) { return _em.ccall("csmGetDrawableVertexCounts", "number", ["number"], [model]) };
        _csm.getDrawableVertexPositions = function(model) { return _em.ccall("csmGetDrawableVertexPositions", "number", ["number"], [model]) };
        _csm.getDrawableVertexUvs = function(model) { return _em.ccall("csmGetDrawableVertexUvs", "number", ["number"], [model]) };
        _csm.getDrawableIndexCounts = function(model) { return _em.ccall("csmGetDrawableIndexCounts", "number", ["number"], [model]) };
        _csm.getDrawableIndices = function(model) { return _em.ccall("csmGetDrawableIndices", "number", ["number"], [model]) };
        _csm.mallocMoc = function(mocSize) { return _em.ccall("csmMallocMoc", "number", ["number"], [mocSize]) };
        _csm.mallocModelAndInitialize = function(moc) { return _em.ccall("csmMallocModelAndInitialize", "number", ["number"], [moc]) };
        _csm.malloc = function(size) { return _em.ccall("csmMalloc", "number", ["number"], [size]) };
        _csm.updateModel = function(model) { _em.ccall("csmUpdateModel", null, ["number"], [model]) };
        _csm.readCanvasInfo = function(model, outSizeInPixels, outOriginInPixels, outPixelsPerUnit) { _em.ccall("csmReadCanvasInfo", null, ["number", "number", "number", "number"], [model, outSizeInPixels, outOriginInPixels, outPixelsPerUnit]) };
        _csm.resetDrawableDynamicFlags = function(model) { _em.ccall("csmResetDrawableDynamicFlags", null, ["number"], [model]) };
        _csm.free = function(memory) { _em.ccall("csmFree", null, ["number"], [memory]) };
        return _csm
    }();
    var Moc = function() {
        function Moc(mocBytes) {
            ...
            if (!this._ptr) { _csm.free(memory) }
        }
        Moc.fromArrayBuffer = function(buffer) { if (!buffer) { return null } var moc = new Moc(buffer); return moc._ptr ? moc : null };
    ...
    var Model = function() {
        ...
        Model.fromMoc = function(moc) { var model = new Model(moc); return model._ptr ? model : null };
        Model.prototype.update = function() { _csm.updateModel(this._ptr) };
    ...
    var Parameters = function() {
        function Parameters(modelPtr) {
            ...
            for (var i = 0; i < _ids.length; i++) { this.ids[i] = _em.Pointer_stringify(_ids[i]) }
            length = _csm.getParameterCount(modelPtr);
    ...
    var Drawables = function() {
        function Drawables(modelPtr) {
            ...
            for (var i = 0; i < _masks.length; i++) { this.masks[i] = new Int32Array(_em.HEAP32.buffer, _masks[i], length2[i]) }
            length = _csm.getDrawableCount(modelPtr);
            ...
            for (var i = 0; i < _vertexPositions.length; i++) { this.vertexPositions[i] = new Float32Array(_em.HEAPF32.buffer, _vertexPositions[i], length2[i] * 2) }
            length = _csm.getDrawableCount(modelPtr);
            length2 = new Int32Array(_em.HEAP32.buffer, _csm.getDrawableVertexCounts(modelPtr), length);
            ...
            for (var i = 0; i < _vertexUvs.length; i++) { this.vertexUvs[i] = new Float32Array(_em.HEAPF32.buffer, _vertexUvs[i], length2[i] * 2) }
            length = _csm.getDrawableCount(modelPtr);
            ...
            for (var i = 0; i < _indices.length; i++) { this.indices[i] = new Uint16Array(_em.HEAPU16.buffer, _indices[i], length2[i]) }
        }
        Drawables.prototype.resetDynamicFlags = function() { _csm.resetDrawableDynamicFlags(this._modelPtr) };
        return Drawables
    }();
    Live2DCubismCore.Drawables = Drawables;
    var Utils = function() {
        function Utils() {}
        Utils.hasBlendAdditiveBit = function(bitfield) { return (bitfield & 1 << 0) == 1 << 0 };
        Utils.hasBlendMultiplicativeBit = function(bitfield) { return (bitfield & 1 << 1) == 1 << 1 };
        Utils.hasIsDoubleSidedBit = function(bitfield) { return (bitfield & 1 << 2) == 1 << 2 };
        Utils.hasIsVisibleBit = function(bitfield) { return (bitfield & 1 << 0) == 1 << 0 };
        Utils.hasVisibilityDidChangeBit = function(bitfield) { return (bitfield & 1 << 1) == 1 << 1 };
        Utils.hasOpacityDidChangeBit = function(bitfield) { return (bitfield & 1 << 2) == 1 << 2 };
        Utils.hasDrawOrderDidChangeBit = function(bitfield) { return (bitfield & 1 << 3) == 1 << 3 };
        Utils.hasRenderOrderDidChangeBit = function(bitfield) { return (bitfield & 1 << 4) == 1 << 4 };
        Utils.hasVertexPositionsDidChangeBit = function(bitfield) { return (bitfield & 1 << 5) == 1 << 5 };
        return Utils
    }();
